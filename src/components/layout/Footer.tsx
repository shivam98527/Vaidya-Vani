...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-50 dark:bg-gray-900 transition-colors mt-auto">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center">
              <span className="text-blue-600 dark:text-blue-400 text-2xl font-bold">MediConnect</span>
            </Link>
            <p className="mt-4 text-sm text-gray-500 dark:text-gray-400">
              Connecting patients with healthcare professionals for quality telehealth services.
            </p>
          ...
          <div className="md:col-span-3 grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li>
                  <Link to="/guides" className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                    Guides
                  </Link>
                </li>
                <li>
                  <Link to="/blog" className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                    Health Blog
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li>
                  <Link to="/careers" className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                    Careers
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/press" className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                    Press
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li>
                  <Link to="/hipaa" className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                    HIPAA Compliance
                  </Link>
                </li>
              </ul>
